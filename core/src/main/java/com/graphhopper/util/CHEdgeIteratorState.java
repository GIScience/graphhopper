...
public interface CHEdgeIteratorState extends EdgeIteratorState {
    ...
    // ORS-GH MOD START: TD CALT TODO ORS: this class was removed upstream, check how to modify CALT so we don't need to reintroduce this class
