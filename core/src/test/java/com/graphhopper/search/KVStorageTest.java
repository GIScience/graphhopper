...
public class KVStorageTest {
    ...
    // ORS-GH BACKPORT: tests for addTags(Map<String,Object>)
    @Test
    void testAddTagsBasic() {
        ...
        Map<String, Object> result = index.getMap(pointer);
    ...
    void testAddTagsForwardBackwardBothSet() {
        ...
        Map<String, KValue> all = index.getAll(pointer);
    ...
    void testAddTagsInterleaveWithAdd() {
        // addTags and add(Map<String,KValue>) must not corrupt each other
        KVStorage index = create();
